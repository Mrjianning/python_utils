...
def plot_result(frame, results):
    for res in results:
        ...
        # cv2.putText(frame, str(class_id), (int(x), int(y - 5)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
        
        cv2.imwrite(r"C:\Users\Administrator\Pictures\res.jpg", frame)


def main():
    # 配置参数
    url = r"C:\Users\Administrator\Pictures\bb.jpg"
    model_url = "http://192.168.1.66:10003/ocr1"
